...
class JsonConvert<T> {
    ...
    switch (type) {			case LiveEntity:
			...
			return liveDataRecommendDataLivesCoverFromJson(data as LiveDataRecommendDataLivesCover, json) as T;			case HotEntity:
			...
			return hotDataItemArgsFromJson(data as HotDataItemArgs, json) as T;			case RecommendEntity:
    ...
    return data as T;
		...
		switch (type) {			case LiveEntity:
			...
			return liveDataRecommendDataLivesCoverToJson(data as LiveDataRecommendDataLivesCover);			case HotEntity:
			...
			return hotDataItemArgsToJson(data as HotDataItemArgs);			case RecommendEntity:
    ...
    switch (T.toString()) {			case 'LiveEntity':
			...
			return LiveDataRecommendDataLivesCover().fromJson(json) as T;			case 'HotEntity':
			...
			return HotDataItemArgs().fromJson(json) as T;			case 'RecommendEntity':
