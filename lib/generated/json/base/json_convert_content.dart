...
import 'package:xbilibili/generated/json/video_detail_v3_entity_helper.dart';
...
class JsonConvert<T> {
    ...
    switch (type) {			case HotEntity:
			...
			return hotDataItemArgsFromJson(data as HotDataItemArgs, json) as T;			case VideoDetailV3Entity:
			return videoDetailV3EntityFromJson(data as VideoDetailV3Entity, json) as T;			case VideoDetailV3Data:
			return videoDetailV3DataFromJson(data as VideoDetailV3Data, json) as T;			case VideoDetailV3DataDash:
			return videoDetailV3DataDashFromJson(data as VideoDetailV3DataDash, json) as T;			case VideoDetailV3DataDashVideo:
			return videoDetailV3DataDashVideoFromJson(data as VideoDetailV3DataDashVideo, json) as T;			case VideoDetailV3DataDashAudio:
			return videoDetailV3DataDashAudioFromJson(data as VideoDetailV3DataDashAudio, json) as T;			case VideoDetailV3DataDurl:
			return videoDetailV3DataDurlFromJson(data as VideoDetailV3DataDurl, json) as T;			case ReplyEntity:
			...
			return replyDataControlFromJson(data as ReplyDataControl, json) as T;			case RecommendEntity:
			...
			return recommendDataOfficialFromJson(data as RecommendDataOfficial, json) as T;			case VideoUrlEntity:
			return videoUrlEntityFromJson(data as VideoUrlEntity, json) as T;			case VideoUrlDurl:
			return videoUrlDurlFromJson(data as VideoUrlDurl, json) as T;			case LiveInfoEntity:
			...
			return liveInfoDataStudioInfoFromJson(data as LiveInfoDataStudioInfo, json) as T;			case VideoDetailEntity:
			...
			return videoDetailDataConfigFromJson(data as VideoDetailDataConfig, json) as T;			case LiveUrlEntity:
    ...
    return data as T;
		...
		switch (type) {			case HotEntity:
			...
			return hotDataItemArgsToJson(data as HotDataItemArgs);			case VideoDetailV3Entity:
			return videoDetailV3EntityToJson(data as VideoDetailV3Entity);			case VideoDetailV3Data:
			return videoDetailV3DataToJson(data as VideoDetailV3Data);			case VideoDetailV3DataDash:
			return videoDetailV3DataDashToJson(data as VideoDetailV3DataDash);			case VideoDetailV3DataDashVideo:
			return videoDetailV3DataDashVideoToJson(data as VideoDetailV3DataDashVideo);			case VideoDetailV3DataDashAudio:
			return videoDetailV3DataDashAudioToJson(data as VideoDetailV3DataDashAudio);			case VideoDetailV3DataDurl:
			return videoDetailV3DataDurlToJson(data as VideoDetailV3DataDurl);			case ReplyEntity:
			...
			return replyDataControlToJson(data as ReplyDataControl);			case RecommendEntity:
			...
			return recommendDataOfficialToJson(data as RecommendDataOfficial);			case VideoUrlEntity:
			return videoUrlEntityToJson(data as VideoUrlEntity);			case VideoUrlDurl:
			return videoUrlDurlToJson(data as VideoUrlDurl);			case LiveInfoEntity:
			...
			return liveInfoDataStudioInfoToJson(data as LiveInfoDataStudioInfo);			case VideoDetailEntity:
			...
			return videoDetailDataConfigToJson(data as VideoDetailDataConfig);			case LiveUrlEntity:
    ...
    switch (T.toString()) {			case 'HotEntity':
			...
			return HotDataItemArgs().fromJson(json) as T;			case 'VideoDetailV3Entity':
			return VideoDetailV3Entity().fromJson(json) as T;			case 'VideoDetailV3Data':
			return VideoDetailV3Data().fromJson(json) as T;			case 'VideoDetailV3DataDash':
			return VideoDetailV3DataDash().fromJson(json) as T;			case 'VideoDetailV3DataDashVideo':
			return VideoDetailV3DataDashVideo().fromJson(json) as T;			case 'VideoDetailV3DataDashAudio':
			return VideoDetailV3DataDashAudio().fromJson(json) as T;			case 'VideoDetailV3DataDurl':
			return VideoDetailV3DataDurl().fromJson(json) as T;			case 'ReplyEntity':
			...
			return ReplyDataControl().fromJson(json) as T;			case 'RecommendEntity':
			...
			return RecommendDataOfficial().fromJson(json) as T;			case 'VideoUrlEntity':
			return VideoUrlEntity().fromJson(json) as T;			case 'VideoUrlDurl':
			return VideoUrlDurl().fromJson(json) as T;			case 'LiveInfoEntity':
			...
			return LiveInfoDataStudioInfo().fromJson(json) as T;			case 'VideoDetailEntity':
			...
			return VideoDetailDataConfig().fromJson(json) as T;			case 'LiveUrlEntity':
